...
import { createReceiverLinkingBank } from 'services/linking-bank';
import { createReceiver } from 'services/receiver';

const ReceiverLienNganHangForm = (props) => {
  ...
  const onSubmit = async () => {
    ...
    const [err_1] = await to(createReceiverLinkingBank({
...
export default ReceiverLienNganHangForm;